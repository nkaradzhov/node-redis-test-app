...
DEBUG_MAINTENANCE=${DEBUG_MAINTENANCE:-false}
...
RUN_ENV="WORKLOAD=$WORKLOAD REPLICAS=$REPLICAS RUN_ID=$RUN_ID LOG_LEVEL=$LOG_LEVEL LOG_PRETTY=$LOG_PRETTY METRICS_INTERVAL_MS=$METRICS_INTERVAL_MS METRICS_EXPORTER_ENDPOINT=$METRICS_EXPORTER_ENDPOINT ENABLE_OTEL=$ENABLE_OTEL APP_NAME=$APP_NAME VERSION=$VERSION DEBUG_MAINTENANCE=$DEBUG_MAINTENANCE"
