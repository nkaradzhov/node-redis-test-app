...
REDIS_DEBUG_MAINTENANCE=${REDIS_DEBUG_MAINTENANCE:-false}
...
RUN_ENV="WORKLOAD=$WORKLOAD REPLICAS=$REPLICAS RUN_ID=$RUN_ID LOG_LEVEL=$LOG_LEVEL LOG_PRETTY=$LOG_PRETTY METRICS_INTERVAL_MS=$METRICS_INTERVAL_MS METRICS_EXPORTER_ENDPOINT=$METRICS_EXPORTER_ENDPOINT ENABLE_OTEL=$ENABLE_OTEL APP_NAME=$APP_NAME VERSION=$VERSION REDIS_DEBUG_MAINTENANCE=$REDIS_DEBUG_MAINTENANCE"
BUILD_ENV="REPO_URL=$REPO_URL REPO_BRANCH=$REPO_BRANCH REPO_COMMIT=$REPO_COMMIT"
